...
<head>
  ...
  <title>Admin | Yamaha Prima Motor</title>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{ URL::asset('admin/font-awesome-4.7.0/css/font-awesome.min.css') }}">
  <!-- Select 2 -->
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="{{url('admin/master/divisi/index')}}"><i class="fa fa-angle-right"></i><span>Divisi</span></a></li>
              <li><a href="{{url('admin/master/jabatan/index')}}"><i class="fa fa-angle-right"></i><span>Jabatan</span></a></li>
              <li><a href="{{url('admin/master/karyawan/index')}}"><i class="fa fa-angle-right"></i><span>Karyawan</span></a></li>
              <li><a href="{{url('/admin/master/tipe/index')}}"><i class="fa fa-angle-right"></i><span>Kategori</span></a>
              </li>
              <li><a href=""><i class="fa fa-angle-right"></i><span>Leasing</span></a>
              <li><a href="{{url('/admin/master/motor/index/')}}"><i class="fa fa-angle-right"></i><span>Motor</span></a></li>
              <li><a href="{{url('/admin/master/warna/index')}}"><i class="fa fa-angle-right"></i><span>Warna</span></a></li>

            </ul>
          </li>
          <li><a href="{{url('admin/promo/index')}}"><i class="fa fa-exclamation-circle"></i><span>Promo</span><i class="fa fa-angle-left"></i></a></li>
          <li><a href=""><i class="fa fa-file-o"></i><span>Order</span><i class="fa fa-angle-left"></i></a></li>
          <li><a href=""><i class="fa fa-user"></i><span>Sales Person</span><i class="fa fa-angle-left"></i></a></li>
          <li class="treeview">
